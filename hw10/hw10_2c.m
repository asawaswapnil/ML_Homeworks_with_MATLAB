...
%bagging
 [test_y_5bag] = Bag_classifier(tr_x,tr_y,test_x,['[@DT_base_simple,',num2str(5),',[]]']);
[test_y_base] = Bag_classifier(tr_x,tr_y,test_x,'[@DT_base_simple,1,[]]');
...
for i=1:10
    for j=1:20
        [test_y_bag(:,i)] = Bag_classifier(tr_x,tr_y,test_x,['[@DT_base_simple,',num2str(i),',[]]']);
...
for i=1:10
    for j=1:20
        [test_y_boost(:,i)] = Boost_classifier(tr_x,tr_y,test_x,['[@DT_base_simple,',num2str(i),',[]]']);
...
for i=1:10
    for j=1:20
        [test_y_bag(:,i)] = Bag_classifier(tr_x,tr_y,tr_x,['[@DT_base_simple,',num2str(i),',[]]']);
...
for i=1:10
    for j=1:20
        [test_y_boost(:,i)] = Boost_classifier(tr_x,tr_y,tr_x,['[@DT_base_simple,',num2str(i),',[]]']);
