...
new_tree=fitctree(x,y,'Prune','on' ,'splitcriterion','gdi');
%%% show the tree logic
view(new_tree);
%%% show the graphics of thenew_tree=fitctree(x,y,'MaxNumSplits',17, 'MinParentSize',20,'MinLeafSize',4,'splitcriterion','deviance');
 tree
